...
public class ImageEditor extends ApplicationAdapter {
	...
	private void createGraphicalElements() {
		...
		new ColorButton(new Vector2(42, 42), new Vector2(0, 84), Color.RED);
		new ColorButton(new Vector2(42, 42), new Vector2(42, 84), Color.PINK);
		new ColorButton(new Vector2(42, 42), new Vector2(0, 126), Color.PURPLE);
		new ColorButton(new Vector2(42, 42), new Vector2(42, 126), Color.YELLOW);
		new ColorButton(new Vector2(42, 42), new Vector2(0, 168), Color.GRAY);
		new ColorButton(new Vector2(42, 42), new Vector2(42, 168), Color.BLACK);
		new ColorButton(new Vector2(42, 42), new Vector2(0, 210), Color.LIME);
		new ColorButton(new Vector2(42, 42), new Vector2(42, 210), Color.WHITE);
